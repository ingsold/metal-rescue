...
import { Download, Beaker, Trash2 } from 'lucide-react';
...
export const AdminGoldenSet: React.FC = () => {
  ...
  return (
    <div className=" bg-sabbath-900 border border-sabbath-800 p-6 rounded-xl">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4 border-b border-sabbath-800 pb-4">
        <div>
